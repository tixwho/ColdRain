...
public abstract class AbstractPlaylistReader {
    ...
    public void read(File f) throws PlaylistIOException, NativeReflectionException {
        logger.info("Start reading com.coldrain.playlist " + f.toString());
        ...
        readEnding();
        closeStream();
        logger.debug("Reading com.coldrain.playlist complete!" + f);
     ...
     * correspondingly. If song instance in com.coldrain.playlist file occupy more than one line, then extra
     ...
     * 
     * @return Arraylist of AbstractPlaylistSong read from the com.coldrain.playlist.
     */
    ...
    protected void setStream(File f) throws PlaylistIOException {
        try {
            ...
            throw new PlaylistIOException("Error in reading com.coldrain.playlist file", fnfe,
                ErrorCodes.BASE_IO_ERROR);
