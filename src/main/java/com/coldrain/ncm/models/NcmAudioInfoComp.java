...
import com.coldrain.ncm.jsonSupp.Album;
import com.coldrain.ncm.jsonSupp.Dj;
...
public class NcmAudioInfoComp {
    ...
    // if com.coldrain.playlist(existed in web_offline_track), then the following will not be null;
