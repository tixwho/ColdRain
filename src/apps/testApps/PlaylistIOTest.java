...
public class PlaylistIOTest extends BaseLocalTestingClass {
    ...
    public static void main(String[] args) throws PlaylistIOException, NativeReflectionException {
        tim.timerStart();
        ...
        PlaylistIOTest testInstance = new PlaylistIOTest();
        ...
        reader.read(src2);
        aTable =(M3uTable) reader.getTable();
        writer.setSongArrList(aTable.getSongArrList());
        writer.write(src4,true);
